		...
		public void listFolders(Account account, Folder[] folders)
		{
			...
			for (Folder folder : folders)
			{
				...
				if (mHideCurrentFolder
						&& (name.equals(mFolder) || (mAccount.getInboxFolderName().equalsIgnoreCase(mFolder) && mAccount.getInboxFolderName().equalsIgnoreCase(
								name))))
				{
					continue;
				}
			...
			List<String> localFolders = new ArrayList<String>(newFolders.size() + topFolders.size() + ((mShowOptionNone) ? 1 : 0));
