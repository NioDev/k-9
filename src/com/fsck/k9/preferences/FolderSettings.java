...
public class FolderSettings
{
	...
	static
	{
		...
		s.put("displayMode", Settings.versions(new V(1, new EnumSetting<FolderClass>(FolderClass.class, FolderClass.NO_CLASS))));
		s.put("syncMode", Settings.versions(new V(1, new EnumSetting<FolderClass>(FolderClass.class, FolderClass.INHERITED))));
		s.put("pushMode", Settings.versions(new V(1, new EnumSetting<FolderClass>(FolderClass.class, FolderClass.INHERITED))));
	...
	public static Map<String, String> getFolderSettings(SharedPreferences storage, String uuid, String folderName)
	{
