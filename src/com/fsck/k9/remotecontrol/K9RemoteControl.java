 ...
 * <uses-permission android:name="com.fsck.k9.permission.REMOTE_CONTROL"/> in
 * their AndroidManifest.xml In addition, all applications sending remote
 * control messages to K-9 Mail must
 * 
...
public class K9RemoteControl
{
	...
	// "com.fsck.k9.K9RemoteControl.checkMail";
