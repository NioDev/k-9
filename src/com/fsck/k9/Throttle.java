...
{
	public static final boolean DEBUG = false; // Don't
												// submit
												// with
												// true
	...
	/* package */Throttle(String name, Runnable callback, Handler handler, int minTimeout, int maxTimeout, Clock clock, Timer timer)
	{
	...
	private class MyTimerTask extends TimerTask
	{
		...
		private class HandlerRunnable implements Runnable
		{
			...
			public void run()
			{
				mRunningTimerTask = null;
				if (!mCanceled)
				{ // This check has to be done on the UI thread.
					if (DEBUG)
