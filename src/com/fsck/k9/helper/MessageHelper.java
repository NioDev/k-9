...
public class MessageHelper
{
	...
	public void populate(final MessageInfoHolder target, final Message message, final FolderInfoHolder folder, final Account account)
	{
	...
	public CharSequence getDisplayName(Account account, Address[] fromAddrs, Address[] toAddrs)
	{
		...
		if (fromAddrs.length > 0 && account.isAnIdentity(fromAddrs[0]))
		{
			...
			displayName = new SpannableStringBuilder(mContext.getString(R.string.message_to_label)).append(to);
		}
		else
		{
