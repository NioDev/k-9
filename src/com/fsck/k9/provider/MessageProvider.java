...
public class MessageProvider extends ContentProvider
{
	...
	protected static interface QueryHandler
	{
		 ...
		 */
		Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) throws Exception;
	}
	...
	public static class DeleteUriExtractor implements FieldExtractor<MessageInfoHolder, String>
	{
		...
		public String getField(final MessageInfoHolder source)
		{
			...
			return CONTENT_URI + "/delete_message/" + message.getFolder().getAccount().getAccountNumber() + "/" + message.getFolder().getName() + "/"
					+ message.getUid();
		}
	}
	...
	protected class MessagesQueryHandler implements QueryHandler
	{
		...
		protected MatrixCursor getMessages(final String[] projection) throws InterruptedException
		{
			...
			msgController.searchLocalMessages(integratedInboxAccount.getRelatedSearch(), new MesssageInfoHolderRetrieverListener(queue));
	...
	protected class AccountsQueryHandler implements QueryHandler
	{
		...
		@Override
		public Cursor query(final Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) throws Exception
		{
		...
		public Cursor getAllAccounts(String[] projection)
		{
			...
			if (projection == null)
			{
				projection = new String[]
					{ FIELD_ACCOUNT_NUMBER, FIELD_ACCOUNT_NAME };
			}
	...
	protected class MesssageInfoHolderRetrieverListener extends MessagingListener
	{
		...
		@Override
		public void listLocalMessagesAddMessages(final Account account, final String folderName, final List<Message> messages)
		{
	...
	public static final String AUTHORITY = "com.fsck.k9.fork.messageprovider";

	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY);

	private static final String[] DEFAULT_MESSAGE_PROJECTION = new String[]
		{ MessageColumns._ID, MessageColumns.SEND_DATE, MessageColumns.SENDER, MessageColumns.SUBJECT, MessageColumns.PREVIEW, MessageColumns.ACCOUNT,
