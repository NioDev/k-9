...
public class DomainNameChecker
{
	...
	{
		if ((certificate == null) || (thisDomain == null) || thisDomain.isEmpty())
		{
			return false;
		}
	...
	private static boolean isIpAddress(String domain)
	{
		...
		catch (UnknownHostException e)
		{
			...
			if (K9.DEBUG)
			{
				Log.v(K9.LOG_TAG, "DomainNameChecker.isIpAddress(): " + errorMessage);
			}
	...
	private static boolean matchDns(String thisDomain, String thatDomain)
	{
		...
		if ((thisDomain == null) || thisDomain.isEmpty() || (thatDomain == null) || thatDomain.isEmpty())
		{
			return false;
		}
