...
public class NotificationActionService extends CoreService
{
	...
	public static PendingIntent getReadAllMessagesIntent(Context context, final Account account, final ArrayList<MessageReference> refs)
	{
		Intent i = new Intent(context, NotificationActionService.class);
		i.putExtra(EXTRA_ACCOUNT, account.getUuid());
	...
	public static Intent getDeleteAllMessagesIntent(Context context, final Account account, final ArrayList<MessageReference> refs)
	{
		Intent i = new Intent(context, NotificationActionService.class);
		i.putExtra(EXTRA_ACCOUNT, account.getUuid());
		i.putExtra(EXTRA_MESSAGE_LIST, refs);
	...
	public int startService(Intent intent, int startId)
	{
		...
		if (account != null)
		{
			if (READ_ALL_ACTION.equals(action))
			{
				...
				ArrayList<MessageReference> refs = intent.getParcelableArrayListExtra(EXTRA_MESSAGE_LIST);
