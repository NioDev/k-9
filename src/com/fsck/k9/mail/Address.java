	...
	public static Address[] parse(String addressList)
	{
		...
		try
		{
			...
			for (int i = 0, count = parsedList.size(); i < count; i++)
			{
				...
				{
					Log.e(K9.LOG_TAG, "Unknown address type from Mime4J: " + address.getClass().toString());
				}
			}
		}
		...
		else if (contacts != null)
		{
			...
			if (name != null)
			{
				if (K9.changeContactNameColor())
				{
					...
					coloredName.setSpan(new ForegroundColorSpan(K9.getContactNameColor()), 0, coloredName.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
					return coloredName;
				}
				else
				{
