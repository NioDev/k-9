...
public class EncoderUtil
{
	...
	private static final int ENCODED_WORD_MAX_LENGTH = 75; // RFC
															// 2047
	...
	private static String encodeQ(String prefix, String text, Charset charset, byte[] bytes)
	{
		...
		if (totalLength <= ENCODED_WORD_MAX_LENGTH)
		{
			return prefix + org.apache.james.mime4j.codec.EncoderUtil.encodeQ(bytes, org.apache.james.mime4j.codec.EncoderUtil.Usage.WORD_ENTITY)
					+ ENC_WORD_SUFFIX;
		}
		else
		{
