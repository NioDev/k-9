...
public class ActivityListener extends MessagingListener
{
	...
	public String getOperation(Context context)
	{
		...
		if (mLoadingAccountDescription != null || mSendingAccountDescription != null || mLoadingHeaderFolderName != null
		...
		else
		{
			...
			if (nextPollTime != -1)
			{
				operation = context.getString(R.string.status_next_poll,
						DateUtils.getRelativeTimeSpanString(nextPollTime, System.currentTimeMillis(), DateUtils.MINUTE_IN_MILLIS, 0));
			}
