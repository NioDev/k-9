...
public class LocalSearch implements SearchSpecification
{
	...
	public List<String> getFolderNames()
	{
		...
		{
			if (node.mCondition.field == Searchfield.FOLDER && node.mCondition.attribute == Attribute.EQUALS)
			{
	...
	public String getRemoteSearchArguments()
	{
		...
		{
			if (node.getCondition().field == Searchfield.SUBJECT || node.getCondition().field == Searchfield.SENDER)
			{
	...
	public String[] getAccountUuids()
	{
		...
		{
			return new String[]
				{ SearchSpecification.ALL_ACCOUNTS };
		}
