...
public class Contacts
{
	 ...
	 */
	protected static final String SORT_ORDER = ContactsContract.CommonDataKinds.Email.TIMES_CONTACTED + " DESC, " + ContactsContract.Contacts.DISPLAY_NAME
	...
	protected static final String PROJECTION[] =
		{ ContactsContract.CommonDataKinds.Email._ID, ContactsContract.Contacts.DISPLAY_NAME, ContactsContract.CommonDataKinds.Email.DATA,
	...
	public ContactItem extractInfoFromContactPickerIntent(final Intent intent)
	{
		...
		try
		{
			...
			cursor = mContentResolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI, PROJECTION, ContactsContract.CommonDataKinds.Email.CONTACT_ID
					+ "=?", new String[]
				{ id }, null);
	...
	public Uri getPhotoUri(String address)
	{
		...
		try
		{
			...
			Cursor cur = mContentResolver.query(ContactsContract.Data.CONTENT_URI, null, ContactsContract.Data.CONTACT_ID + "=" + contactId + " AND "
	...
	public boolean hasContactPicker()
	{
		...
		{
			mHasContactPicker = !(mContext.getPackageManager().queryIntentActivities(contactPickerIntent(), 0).isEmpty());
		}
