...
public class AccountSetupBasics extends K9Activity implements OnClickListener, TextWatcher
{
	...
	private void finishAutoSetup()
	{
		...
		try
		{
			...
			incomingUri = new URI(incomingUriTemplate.getScheme(), incomingUsername + ":" + passwordEnc, incomingUriTemplate.getHost(),
			...
			if (outgoingUsername != null)
			{
				...
				outgoingUri = new URI(outgoingUriTemplate.getScheme(), outgoingUsername + ":" + passwordEnc, outgoingUriTemplate.getHost(),
	...
	private Provider findProviderForDomain(String domain)
	{
		try
		{
			...
			{
				if (xmlEventType == XmlResourceParser.START_TAG && "provider".equals(xml.getName()) && domain.equalsIgnoreCase(getXmlAttribute(xml, "domain")))
				{
