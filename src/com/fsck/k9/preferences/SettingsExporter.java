...
public class SettingsExporter
{
	...
	public static void exportPreferences(Context context, OutputStream os, boolean includeGlobals, Set<String> accountUuids)
	...
	private static void writeSettings(XmlSerializer serializer, Map<String, Object> prefs) throws IOException
	{
		...
		for (Entry<String, TreeMap<Integer, SettingsDescription>> versionedSetting : GlobalSettings.SETTINGS.entrySet())
		{
			...
			if (valueString != null)
			{
				...
				{
					Log.w(K9.LOG_TAG, "Global setting \"" + key + "\" has invalid value \"" + valueString + "\" in preference storage. This shouldn't happen!");
				}
			}
			else
			{
		...
		for (Map.Entry<String, Object> entry : prefs.entrySet())
		{
			...
			if (versionedSetting != null)
			{
				...
				if (setting != null)
				{
					...
					{
						Log.w(K9.LOG_TAG, "Account setting \"" + keyPart + "\" (" + account.getDescription() + ") has invalid value \"" + valueString
		...
		for (Map.Entry<String, Object> entry : prefs.entrySet())
		{
			...
			if (versionedSetting != null)
			{
				...
				if (setting != null)
				{
					...
					{
						Log.w(K9.LOG_TAG, "Identity setting \"" + identityKey + "\" has invalid value \"" + valueString
								+ "\" in preference storage. This shouldn't happen!");
					}
				}
			}
	...
	private static void writeElement(XmlSerializer serializer, String elementName, String value) throws IllegalArgumentException, IllegalStateException,
			IOException
	{
		if (value != null)
		{
