...
public class ColorPickerDialog extends AlertDialog
{
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener, int color)
	{
		...
		setButton(BUTTON_POSITIVE, context.getString(R.string.okay_action), new DialogInterface.OnClickListener()
		{
			@Override
		...
		setButton(BUTTON_NEGATIVE, context.getString(R.string.cancel_action), (OnClickListener) null);
	}
