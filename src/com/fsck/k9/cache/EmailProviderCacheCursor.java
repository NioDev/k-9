...
public class EmailProviderCacheCursor extends CursorWrapper
{
	...
	public EmailProviderCacheCursor(String accountUuid, Cursor cursor, Context context)
	{
		...
		{
			throw new IllegalArgumentException("The supplied cursor needs to contain the " + "following columns: " + MessageColumns.ID + ", "
					+ MessageColumns.FOLDER_ID + ", " + ThreadColumns.ROOT);
		}
