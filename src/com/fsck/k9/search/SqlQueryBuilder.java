...
public class SqlQueryBuilder
{
			...
			switch (condition.field)
				...
				case SEARCHABLE:
				{
					switch (account.getSearchableFolders())
						...
						case ALL:
						{
							// Create temporary LocalSearch object so we can
							// use...
							LocalSearch tempSearch = new LocalSearch();
							// ...the helper methods in Account to create the
						...
						case DISPLAYABLE:
						{
							...
							// ...the helper methods in Account to create the
							// necessary conditions
							// to limit the selection to displayable,
							// non-special folders.
	...
	private static void appendCondition(SearchCondition condition, StringBuilder query, List<String> selectionArgs)
	{
